...
diagram.add_node(id="VBRREPOWIN01",label="VBRREPOWIN01",style=styles_dir+"/VBRPOWERNFS.txt",x_pos="420",y_pos="410",width="60",height="60",data={"ip": "192.168.204.100","role":"VBRPOWERNFS","other_roles":"VBRBACKUPREPOSITORY,VBRBACKUPREPOSITORYWINDOWS,VBRMOUNTSERVER"})
